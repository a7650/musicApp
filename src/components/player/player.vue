    ...
    <div class="player" v-show="playList.length>0">
        ...
        <div class="main-player"  v-show="fullScreen">
            ...
            <header>
                ...
                <div class="singer-name"><span class="line left-line"></span><span class="name">{{currentSong.singer}}</span><span class="line right-line"></span></div>
            </header>
            <!-- main -->
            <div class="main" :class="{blur:listShow}"
                ...
                <div  class="right" ref="mainRight">
                    ...
                    <scroll  class="lyric-content" ref="lyricLists" :data="currentLyric&&currentLyric.lines">
                        ...
                        <ul class="lyric" v-if="currentLyric">
                            <li class="line" ref="lyricList" :class="{'active':lyricLine === index}" v-for="(line,index) in currentLyric.lines" :key="index">
                                {{line.txt}}
                            </li>
                        </ul>
                        </div>
            ...
            <process-bar :nowTime="nowTime" :totalTime="currentSong.duration" @turnProcess="turnProcess"></process-bar>
            <div class="operators">
        ...
        <div class="mini-player" v-show="!fullScreen" @click="showMainPlayer">
           <div class="mini-img">
             <div><div class="mini-bg" :class="cdRotate" :style="bgStyle"></div></div>
           </div>
        ...
        <audio id="audio" ref="audio" @ended="toggleSong" @timeupdate="timeupdate" @play="audioReadyPlay"></audio>
...
export default {
    ...
    computed:{
        ...
        modeIcon(){
            return this.playMode ===  playMode.sequence ? "icon-list-loop" : this.playMode === playMode.loop ? "icon-song-loop" : "icon-list-random"
        },
    ...
    components:{
        playerAnimation,miniList,scroll,miniListAnimation,processBar,scroll
    },
    methods:{
        audioReadyPlay(){
            this.readyPlay = true;
        ...
        mainTouchMove(e){  
            ...
            this.$refs.mainRight.style.marginLeft = `${-(window.innerWidth-now_x)}px`; 
